            ...
            <div style={styles.main}>
                <div style={styles.centerArea}>
                    ...
                    <div id="scrollArea" onScroll={this.bottomCheck} style={styles.centerBottom} >
                        ...
                        <p>After spending 11 years in the United States Army as an Infantry Paratrooper, with combat deployments to  both Iraq and Afghanistan, I was looking to start a new chapter of my life. While earning my BA in Criminal Justice, I was able to maintain a 4.0 GPA and work part-time for TAG Heuer as an E-Learning Administrator / Data Analyst. I continued my education by enrolling in Code Immersives NYC, an 11-month Web Development Program that teaches modern development techniques and standards of practice that go well beyond a typical, 12-week "boot-camp."</p>
